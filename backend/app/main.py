...
async def get_evidence(h3_id: str):
    ...
    return EvidenceResponse(
        ...
        infrastructure={
            "schools": {"source": "UN OCHA / Bangladesh LGED (via HDX)",
                        "update_frequency": "LGED registry", "url": "https://data.humdata.org/dataset/bangladesh-education-facilities-by-lged"},
            "clinics": {"source": "UN OCHA / Bangladesh LGED (via HDX)",
                        "update_frequency": "LGED registry", "url": "https://data.humdata.org/dataset/bangladesh-health-facilities-by-lged"},
        },
